...
#define DrawText(x,y,z,c,f,s) [NSString stringWithFormat:@"<text x=\"%f\" y=\"%f\" font-size=\"%tu\" fill =\"%@\" font-style=\"%@\">%@</text>",x,y,z,c,f,s]

#define DrawTextL(x,y,z,c,f,s) [NSString stringWithFormat:@"<text x=\"%f\" y=\"%f\" font-size=\"%tu\" fill =\"%@\" style=\"text-anchor: left;\" font-style=\"%@\">%@</text>",x,y,z,c,f,s]

#define DrawTextR(x,y,z,c,f,s) [NSString stringWithFormat:@"<text x=\"%f\" y=\"%f\" font-size=\"%tu\" fill =\"%@\" style=\"text-anchor: end\" font-style=\"%@\">%@</text>",x,y,z,c,f,s]

#define DrawTextM(x,y,z,c,f,s) [NSString stringWithFormat:@"<text x=\"%f\" y=\"%f\" font-size=\"%tu\" fill =\"%@\" style=\"text-anchor: middle\" font-style=\"%@\">%@</text>",x,y,z,c,f,s]





#define DrawTextClicked(x,y,z,c,f,s,i) [NSString stringWithFormat:@"<text x=\"%f\" y=\"%f\" font-size=\"%tu\" fill =\"%@\" font-style=\"%@\" onclick=\"self.location.href='@@@@%@'\">%@</text>",x,y,z,c,f,i,s]
...
#define LineInfo(n,c,i,t) [NSString stringWithFormat:@"%@*%@*%tu*%tu",n,c,i,t]
